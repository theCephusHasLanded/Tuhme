        ...
        <div className="nav-container">
          ...
          <div className="nav-actions">
            ...
            >
              ...
              <div className="absolute -inset-1 bg-yellow-500/20 rounded-luxury opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm" />
            </button>
