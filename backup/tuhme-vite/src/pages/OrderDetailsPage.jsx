...
const mockOrderData = {
  'ORD001': {
    ...
    statusHistory: [
      ...
      { status: 'Stylist Assigned', date: '04/10/2025 10:15 AM' }
    ],
    items: [
      {
        id: 'ITM001',
...
// Order status steps
const orderSteps = ['Request Received', 'Stylist Assigned', 'Items Selected', 'Delivery Scheduled', 'Delivered', 'Completed'];
